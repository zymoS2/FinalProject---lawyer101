$(function () {
    ...
    $(document).on("click","input:checkbox[name=chkAgree]",function(){
      ...
      $(".scriptCommonText").on("keyup", function(){
        ...
        var value7 = document.querySelector("#company").value;
        var value8 = document.querySelector("#tel").value;
        var value9 = document.querySelector("#sample6_detailAddress").value;
        var value10= document.querySelector("#registNum").value;
  
        if(email.test(value) && id.test(value1) && name.test(value2) && password.test(value3) == password.test(value5) 
        && phone.test(value6) && value7 !== "" && value8 !== "" && value9 !== "" && lawyerCer.test(value10)){
