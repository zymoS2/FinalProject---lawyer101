  ...
  <main class="form-signup m-auto">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <form class="needs-validation" action="" id="lawyerJoinForm" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select id="gender" name="lawyerGender" class="form-select">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn" id="auth-button">
