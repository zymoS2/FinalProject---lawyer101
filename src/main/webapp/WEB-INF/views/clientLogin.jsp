   ...
   <script type="text/javascript">
     function clientLogin(){
         if(confirm('로그인 하시겠습니까?')){
              var id =  document.getElementsByName('clientId')[0].value;
              var pwd =  document.getElementsByName('clientPwd')[0].value;
...
<main class="form-signin w-100 m-auto">
              <form action="" id="clientLoginForm"  method="post">
                  ...
                  <div class="btn-group" role="group" aria-label="Basic outlined example">
                      ...
                      <button type="button"  onclick="location.href='/lawyerLogin'" class="btn btn-outline-custom btn-outline-info fw-bold rounded-0 w-50" style="height: 55px;">변호사로 로그인</button>
                  </div>
