...
<head>
    ...
    <title>${lawyer.lawyerName} 변호사 - 의뢰인 후기 | 법률서비스 101</title>
</head>
<body>
    <div class="container d-flex">
        ...
        <div class="px-5" style="width: 70%">
            ...
            <h3 class="fw-bold my-1 py-5 text-center border-top border-bottom">실제 상담을 완료한 ${pageReview.getTotal()}건의 <br><span class="text-custom">의뢰인 후기</span>를 확인하세요.</h3>
            <div class="border-top py-5">
                <h5 class="pb-3 border-bottom text-secondary fw-bold">후기 ${pageReview.getTotal()}</h5>
                <ul class="review-list ps-0">
                    <c:forEach var="review" items="${pageReview.getList()}">
    ...
    <script>
        ...
        $("#moreButton").click(function () {
            ...
            $.ajax({
                url: "/product/detail/${lawyer.lawyerNum}/loadReview",
                method: "GET",
                data: {pageNum: pageNum},
                success: function (result) {
                    $(".review-list").append(result);

                    if (pageNum == ${pageReview.getPages()}) {
                        $("#moreButton").hide();
                    }
                },
            })
